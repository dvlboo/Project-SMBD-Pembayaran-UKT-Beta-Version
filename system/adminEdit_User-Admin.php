      ...
      <div class="section-header">
        <h1>Edit User Admin</h1>
          <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item text-primary">Edit Admin</div>
          </div>
      </div>
      <div class="row">
        <div class="col-12">
          ...
          <div class="card-body bg-primary">
              ...
              <div class="col-12 col-lg-8 offset-lg-2">
                <div class="wizard-steps">
                  <div class="wizard-step wizard-step-active">
                    ...
                    <div class="wizard-step-label">Formulir Admin</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <form class="wizard-content mt-2" method="post" action="../process/Admin-Edit_Admin.php">
              <div class="wizard-pane">
                <input type="text" name="id_admin" value="<?php echo $data['id_admin']; ?>" hidden/>                
                  
                <div class="form-group row align-items-center">
                  <label class="col-md-4 text-md-right text-white">Nama Admin</label>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-lg-4 col-md-6 text-right">
                    <button type="submit" class="btn btn-icon icon-right btn-primary">Ubah Data Admin<i class="fas fa-arrow-right"></i></button>
                  </div>
                </div>
              </div>
            </form>
